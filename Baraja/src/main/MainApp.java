...
public class MainApp {
	...
	public static void partida() {
		...
		do {
			juego.menuPrincipal();
			System.out.println("");
			System.out.println("¿Otra partida? Introduce SÍ para continuar o cualquier otro caracter para salir.");
			try {
				restart = s.nextLine();
			} catch (Exception e) {
		...
		} while (restart.equalsIgnoreCase("SÍ") || restart.equalsIgnoreCase("SI"));
...
//						System.out.println("Has sacado el " + aux.getNombreCarta() + "\tTu puntuación: " + puntuacion);
...
//					default:
//						System.out.println(
//								"Por favor, introduce el número 1 o 2 para continuar con el juego o plantarte.");
//						break;
//					}
//
//				} else {
...
//			System.out.println("Qué cagao.");
//		}
//		if (puntuacion > 6 && puntuacion < 7.5) {
//			System.out.println("Uf, ¡qué cerca!");
//		}
//		if (puntuacion == 7.5) {
