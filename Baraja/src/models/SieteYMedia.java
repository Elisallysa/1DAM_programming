			...
			case 3:
				...
				if (Math.round(Math.random()) == 0) {
					...
					do {
						...
						System.out.println("");
						if (jugador1.getPuntos() <= 7.5 && !jugador1.mano.isVacia()) {
				...
				System.out.println("La puntuación final de " + jugador1.nombre + ": " + jugador1.getPuntos());
				System.out.println("La puntuación final de " + jugador2.nombre + ": " + jugador2.getPuntos());
