...
public abstract class AbstractGame {
	...
	/**
	 * Booleano que indicará si el juego se ha terminado o no.
	 */
	...
	/**
	 * Número entero que se podrá usar o no, que representa la ronda del juego.
	 */
	protected int ronda;
	...
	/**
	 * Método que recoge todas las cartas en la mano de los jugadores.
	 */
	public void finish() {
