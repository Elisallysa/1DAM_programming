...
public class CPUPlayer extends AbstractPlayer {
	...
	public void jugarTurno() {
		...
		// Recorre la baraja para saber cuántas cartas no le harían perder la partida al
		// CPU. Solo lo hace si tiene más de 5 puntos.
		...
		if (getPuntos() < 7.5) {
			...
			// El CPU solo robará otra carta si tiene menos de 5 puntos o su probabilidad de
			// conseguir una carta que no le haría perder es mayor del 50%.
